...
!!! initialize parameter_2d_sets
    ...
    pic2d%para2d%tempt=1.5

    !!! particle in cell part
    pic2d%para2d%numparticle=300
...
!print*, "pic2d%para2d%tempt=",pic2d%para2d%tempt
   ful2dtmp=>pic2d%ful2d_head
   call para_accprej_gaus2d2v_fulgyro_unifield_per_per(ful2dtmp,pic2d)
