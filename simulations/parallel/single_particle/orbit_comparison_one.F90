...
!!! initial storting of the particles
...
!!! initialize parameter_2d_sets
    ...
    pic2d%para2d%gxmax=(/3._F64*pi_,3._F64*pi_/)
...
!!! parameters for the electrostatic potential
    pic2d%para2d%amp=1e-2
    pic2d%para2d%wave_one=6.0
    pic2d%para2d%wave_two=6.0
...
if(rank==0) then
  ...
  !!!periodic boundary condition
    ...
    call para_initialize_field_2d_mesh(pic2d%para2d%amp,pic2d%para2d%wave_one, pic2d%para2d%wave_two, pic2d)
...
!num_p=0
  ...
  x(1)=(pic2d%para2d%gxmin(1)+pic2d%para2d%gxmax(1))/2.0
  x(2)=(pic2d%para2d%gxmin(2)+pic2d%para2dùgxmax(2))/2.0
